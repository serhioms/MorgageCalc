...
public class TestMortgagePayment {
	...
	static public BigDecimal PRINCIPAL = new BigDecimal("100000.0", MortgageSettings.MC_CRY);
	...
	static public MortgageContext[] mca = new MortgageContext[]{
		...
		new MortgageContext(ANUAL_RATE, PRINCIPAL, new AmortizationPheriod(AMORTIZATION_PHERIOD_YEARS, 0), START_DATE, YEAR_TERM),
					
		new MortgageContext(ANUAL_RATE, PRINCIPAL, new AmortizationPheriod(AMORTIZATION_PHERIOD_YEARS, 0), START_DATE, YEAR_TERM,
					new BigDecimal("310", MortgageSettings.MC_CRY), ExtraPaymentFrequency.MONTHLY, ExtraPaymentOrder.AFTER_PAYMENTS,
					MAX_MONTH_EXTRAS_PRC, MAX_YEAR_EXTRAS_PRC, MINIMIZE_MO_PAYMENTS),
					
		new MortgageContext(ANUAL_RATE, PRINCIPAL, new AmortizationPheriod(AMORTIZATION_PHERIOD_YEARS, 0), START_DATE, YEAR_TERM,
				new BigDecimal("0", MortgageSettings.MC_CRY), ExtraPaymentFrequency.MONTHLY, ExtraPaymentOrder.AFTER_PAYMENTS),
		
		new MortgageContext(new BigDecimal("0.0285"), new BigDecimal("500"), new AmortizationPheriod(AMORTIZATION_PHERIOD_YEARS, 0), START_DATE, new BigDecimal("50"),
				new BigDecimal("50000", MortgageSettings.MC_CRY), ExtraPaymentFrequency.MONTHLY, ExtraPaymentOrder.BEFORE_PAYMENTS),
	}; 
